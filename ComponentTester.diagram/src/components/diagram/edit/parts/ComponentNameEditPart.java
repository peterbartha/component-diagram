...
public class ComponentNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ComponentModelParserProvider.getParser(ComponentModelElementTypes.Component_2002,
					getParserElement(), ComponentModelVisualIDRegistry
							.getType(components.diagram.edit.parts.ComponentNameEditPart.VISUAL_ID));
		}
		return parser;
	}
