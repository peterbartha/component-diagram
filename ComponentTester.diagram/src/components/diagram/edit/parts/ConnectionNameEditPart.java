...
import components.diagram.edit.policies.ComponentModelTextSelectionEditPolicy;
 ...
 * @generated
 */
public class ConnectionNameEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				ComponentModelVisualIDRegistry.getType(components.diagram.edit.parts.ConnectionNameEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE, new ComponentModelTextSelectionEditPolicy());
	...
	*/
	protected Image getLabelIcon() {
		...
		return ComponentModelElementTypes.getImage(parserElement.eClass());
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ComponentModelParserProvider.getParser(ComponentModelElementTypes.Connection_4001,
					getParserElement(), ComponentModelVisualIDRegistry
							.getType(components.diagram.edit.parts.ConnectionNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, null,
					ComponentModelEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
