...
import components.diagram.edit.policies.PortItemSemanticEditPolicy;
...
public class PortEditPart extends ShapeNodeEditPart {
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof PortNameEditPart) {
			((PortNameEditPart) childEditPart).setLabel(getPrimaryShape().getFigurePortNameFigure());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(ComponentModelVisualIDRegistry.getType(PortNameEditPart.VISUAL_ID));
	}
