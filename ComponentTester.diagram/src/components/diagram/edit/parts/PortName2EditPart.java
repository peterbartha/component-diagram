 ...
 * @generated
 */
public class PortName2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ComponentModelParserProvider.getParser(ComponentModelElementTypes.Port_3001, getParserElement(),
					ComponentModelVisualIDRegistry.getType(components.diagram.edit.parts.PortName2EditPart.VISUAL_ID));
		}
		return parser;
	}
