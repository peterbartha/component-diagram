 ...
 * @generated
 */
public class PortNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ComponentModelParserProvider.getParser(ComponentModelElementTypes.Port_2001, getParserElement(),
					ComponentModelVisualIDRegistry.getType(components.diagram.edit.parts.PortNameEditPart.VISUAL_ID));
		}
		return parser;
	}
