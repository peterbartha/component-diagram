 ...
 * @generated
 */
public class ComponentModelNavigatorContentProvider implements ICommonContentProvider {
	...
	*/
	public Object[] getChildren(Object parentElement) {
		if (parentElement instanceof IFile) {
			...
			result.addAll(createNavigatorItems(selectViewsByType(topViews, ComponentEditPart.MODEL_ID), file, false));
	...
	private Object[] getViewChildren(View view, Object parentElement) {
		...
		case ComponentEditPart.VISUAL_ID: {
			...
			ComponentModelNavigatorGroup links = new ComponentModelNavigatorGroup(
					Messages.NavigatorGroupName_Component_1000_links, "icons/linksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getChildrenByType(Collections.singleton(sv),
					ComponentModelVisualIDRegistry.getType(PortEditPart.VISUAL_ID));
			result.addAll(createNavigatorItems(connectedViews, parentElement, false));
			connectedViews = getChildrenByType(Collections.singleton(sv),
					ComponentModelVisualIDRegistry.getType(Component2EditPart.VISUAL_ID));
			result.addAll(createNavigatorItems(connectedViews, parentElement, false));
			connectedViews = getDiagramLinksByType(Collections.singleton(sv),
					ComponentModelVisualIDRegistry.getType(ConnectionEditPart.VISUAL_ID));
		...
		case PortEditPart.VISUAL_ID: {
			...
			ComponentModelNavigatorGroup incominglinks = new ComponentModelNavigatorGroup(
					Messages.NavigatorGroupName_Port_2001_incominglinks, "icons/incomingLinksNavigatorGroup.gif", //$NON-NLS-1$
					parentElement);
			ComponentModelNavigatorGroup outgoinglinks = new ComponentModelNavigatorGroup(
					Messages.NavigatorGroupName_Port_2001_outgoinglinks, "icons/outgoingLinksNavigatorGroup.gif", //$NON-NLS-1$
					parentElement);
			Collection<View> connectedViews;
		...
		case Component2EditPart.VISUAL_ID: {
			...
			Collection<View> connectedViews;
			connectedViews = getChildrenByType(Collections.singleton(sv),
					ComponentModelVisualIDRegistry.getType(ComponentPortCompartmentEditPart.VISUAL_ID));
			connectedViews = getChildrenByType(connectedViews,
					ComponentModelVisualIDRegistry.getType(Port2EditPart.VISUAL_ID));
			result.addAll(createNavigatorItems(connectedViews, parentElement, false));
			return result.toArray();
		}
		...
		case Port2EditPart.VISUAL_ID: {
			...
			Node sv = (Node) view;
			ComponentModelNavigatorGroup incominglinks = new ComponentModelNavigatorGroup(
					Messages.NavigatorGroupName_Port_3001_incominglinks, "icons/incomingLinksNavigatorGroup.gif", //$NON-NLS-1$
					parentElement);
			ComponentModelNavigatorGroup outgoinglinks = new ComponentModelNavigatorGroup(
					Messages.NavigatorGroupName_Port_3001_outgoinglinks, "icons/outgoingLinksNavigatorGroup.gif", //$NON-NLS-1$
					parentElement);
			Collection<View> connectedViews;
			connectedViews = getIncomingLinksByType(Collections.singleton(sv),
					ComponentModelVisualIDRegistry.getType(ConnectionEditPart.VISUAL_ID));
		...
		case ConnectionEditPart.VISUAL_ID: {
			...
			ComponentModelNavigatorGroup target = new ComponentModelNavigatorGroup(
					Messages.NavigatorGroupName_Connection_4001_target, "icons/linkTargetNavigatorGroup.gif", //$NON-NLS-1$
					parentElement);
			ComponentModelNavigatorGroup source = new ComponentModelNavigatorGroup(
					Messages.NavigatorGroupName_Connection_4001_source, "icons/linkSourceNavigatorGroup.gif", //$NON-NLS-1$
					parentElement);
			Collection<View> connectedViews;
	...
	*/
	 ...
	 * @generated
	 */
	private Collection<ComponentModelNavigatorItem> createNavigatorItems(Collection<View> views, Object parent,
			boolean isLeafs) {
		ArrayList<ComponentModelNavigatorItem> result = new ArrayList<ComponentModelNavigatorItem>(views.size());
		for (View nextView : views) {
			result.add(new ComponentModelNavigatorItem(nextView, parent, isLeafs));
		}
		return result;
	}
